---
title: Avoid intermediate data structure
date: '2023-07-20'
language: en
tags: ['architecture', 'data-structure', 'javascript']
authors: ['default']
draft: false
summary: Why you should avoid using intermediate data structures when working with data
images: []
---
