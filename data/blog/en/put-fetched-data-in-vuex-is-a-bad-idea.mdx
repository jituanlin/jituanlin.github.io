---
title: Put fetched data in Vuex is a bad idea
date: '2023-07-15'
language: en
tags: ['vuex', 'vue', 'state-management']
authors: ['default']
draft: false
summary: Why storing fetched API data in Vuex can lead to several problems in Vue applications
images: []
---

I've noticed that there are too many Vuex states (as seen in the `mapState` usage). I prefer to store fetched data within the component's scope (i.e., `this.data`) rather than in the global Vuex store.
